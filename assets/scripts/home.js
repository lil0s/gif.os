...
listen(".sailor-day", "click", () => { cambiaTema("tema-dia") });
listen(".sailor-night", "click", () => { cambiaTema("tema-noche") });
listen("#flecha-menu-temas", "click", () => { display("#menu-temas") });
...
async function titulosSugeridos()
{
    ...
    //reset
    get("#lupita-buscar").disabled = (texto == "");
...
listen("#inputBusqueda", "input", () => { titulosSugeridos()});
...
listen("#lupita-buscar", "click", () => { buscar()});
